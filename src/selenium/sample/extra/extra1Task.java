...
public class extra1Task {
    ...
    public void navigateBack() throws Exception {
        String baseUrl = "https://kristinek.github.io/site/examples/po";
//        TODO
...
//        open page "https://kristinek.github.io/site/examples/act"
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("show_text"))).click();
        //Thread.sleep(200); // wait for page to redirect, insert Selenium Wait here
//        click on "Show" button in 'Button' section
//        driver.findElement(By.id("show_text")).click();
//        check that text "I am here!" is seen
        WebElement imHere = driver.findElement(By.id("show_me"));
        assertTrue(imHere.isDisplayed());
        assertEquals("I am here!", imHere.getText());
//        refresh page
        driver.navigate().refresh();
//        check that text "I am here!" is not seen
        WebElement imHereRefreshed = driver.findElement(By.id("show_me")); // refresh element after page reload
        assertFalse(imHereRefreshed.isDisplayed());
    }
}
